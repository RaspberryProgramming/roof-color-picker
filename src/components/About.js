  ...
  return (
    <Container className="about-container rounded d-flex flex-column align-items-left justify-content-start">
      <div className="bg-secondary bg-gradient text-white">
        <a href="#" onClick={() => toggleWidget("about")}>
      ...
      <div className="text d-flex flex-column justify-content-center">
        ...
        <div className="d-flex flex-column p-5">
          ...
          <p>Github: <a href="https://github.com/RaspberryProgramming" target="_blank">RaspberryProgramming</a></p>
          <hr />
          <p>Images sourced from:</p>
          <a href="https://www.serrano2roofing.com/" target="_blank">Serrano2Roofing</a>
          <a href="https://www.gaf.com/" target="_blank">GAF Roofing</a>
        </div>
      </div>
    </Container>
  );
